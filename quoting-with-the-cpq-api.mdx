...
After creating a proposal, you can poll this endpoint to check its status. Most quotes are processed within 45 seconds. **To prevent server overload, please limit polling frequency to once every 10-15 seconds.**
